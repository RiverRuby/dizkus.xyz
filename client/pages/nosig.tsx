...
const NoSig: NextPage = () => {
  ...
  async function buttonGenerateProof() {
    ...
    const res = await generateProof('group_message_nosig_86_3_7');
  ...
  async function buttonVerifyProof() {
    ...
    const res = await verifyProof(proof, publicSignals, 'group_message_nosig_86_3_7');
